...
void JetsAnalyzer_MiniAOD::bookHistos(DQMStore::IBooker & ibooker_)
{
  ...
  h_xPt_yPt = ibooker_.book2D("relPt_vs_truePt","",50,0.,500.,500,0.,2.5);
  h_xEta_yPt = ibooker_.book2D("relPt_vs_trueEta","",50,-5.,5.,500,0.,2.5);

  h_xPt_yEta = ibooker_.book2D("etaDiff_vs_truePt","",50,0.,500.,500,-0.4,0.4);
  h_xEta_yEta = ibooker_.book2D("etaDiff_vs_trueEta","",50,-5.,5.,500,-0.4,0.4);

  h_xPt_yPhi = ibooker_.book2D("phiDiff_vs_truePt","",50,0.,500.,500,-0.4,0.4);
  h_xEta_yPhi = ibooker_.book2D("phiDiff_vs_trueEta","",50,-5.,5.,500,-0.4,0.4);
